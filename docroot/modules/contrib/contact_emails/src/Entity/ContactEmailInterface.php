...
interface ContactEmailInterface extends ContentEntityInterface, EntityChangedInterface {
  ...
  /**
   * Get context user|emails from the current route (if any).
   *
   * @param bool $return_owner
   *   Bool to determinate if we should return entity owner or e-mails.
   *
   * @return mixed
   *   An array of e-mails or entity owner or empty value.
   */
