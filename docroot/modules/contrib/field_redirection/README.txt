Field Redirection
-----------------
A field formatter for Link and Entity Reference fields that will perform a HTTP
redirect to the given URL. The formatter's settings allow selection from one of
